$(function () {
    ...
    $("form[name='create_single_name']").validate({
        rules: {
            ...
            collectable_amount: { OrderType: true },
    ...
    $('#length,#width,#height').on('change', function () {
        ...
        var total = ((length * width * height) / 4500);
    ...
    $(document).delegate('.airwaybill_number,#order_type', 'change', function () {
        ...
        if (awb_no && ordertype != "") {
            $.ajax({
                ...
                data: { awb_no: awb_no, ordertype: ordertype },
    ...
    $('.get-price').click(function () {
        ...
        if (pickup_id && deliverd_pincode && pincode && shipment_type && order_type && volumetric_weight && physical_width && logistic != '') {
            $.ajax({
                ...
                data: { logistic: logistic, pickup_id: pickup_id, deliverd_pincode: deliverd_pincode, shipment_type: shipment_type, order_type: order_type, volumetric_weight: volumetric_weight, physical_width: physical_width, collectable_amount: collectable_amount },
                success: function (data) {
                    var data1 = $.trim(data);
    ...
    $('.get-price-simple-order').click(function () {
        ...
        if (pickup_id && deliverd_pincode && shipment_type && order_type && volumetric_weight && physical_width != '') {
            $.ajax({
                ...
                data: { pickup_id: pickup_id, deliverd_pincode: deliverd_pincode, shipment_type: shipment_type, order_type: order_type, volumetric_weight: volumetric_weight, physical_width: physical_width, collectable_amount: collectable_amount },
                success: function (data) {
    ...
    $(document).delegate('.selectable-item', 'change', function () {
        ...
        if ($(this).prop('checked') == true) {
            ...
            $.ajax({
                ...
                data: { cgst: cgst, sgst: sgst, igst: igst, total: total, codamount: codamount },
                success: function (response) {
