 ...
 <section id="hero" class="d-flex align-items-center">
 	<div class="container" data-aos="zoom-out" data-aos-delay="100">
 		<h1>Welcome to <span>Intact Consultancy </span></h1>
 		<h2>WE HONOUR ACT</h2>
 		<div class="d-flex">
 			...
 			<div class="row">
 				<div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
 					<div class="icon-box" data-aos="fade-up" data-aos-delay="100">
 						...
 						<h4 class="title"><a href="">loram </a></h4>
 		...
 		<div class="container" data-aos="fade-up">
 			...
 			<div class="row">
 				...
 				<div class="col-lg-6 pt-4 pt-lg-0 content d-flex flex-column justify-content-center" data-aos="fade-up"
 					data-aos-delay="100">
 					<h3>Intact consultancy is a highly professional outfit having specialization</h3>
 					<p class="fst-italic">
 						in consulting and advisory in labour and industrial laws. We have been working as a plant level
 						management consultant since last 34 years. We provide consulting, advisory and counselling in
 						the area of statutory compliances under various industrial and
 						labour laws.
 					</p>
 					<ul>
 					</ul>
 					<p>
 						We are the leading Labour Laws Consultancy firm providing our services since last three
 						generation and almost with every types of industry. We have a very qualified team of Executives
 						working under the direct supervision of labour laws expert. We have
 						an expert grip over the Payroll Processing and Labour Laws Compliances.
 					</p>
 				</div>
 				<div class="text-center mt-4"><a href="about.html"><button type="submit" class="btn btn-primary">More
 							About</button></a></div>
 			</div>
 		...
 		<div class="container" data-aos="fade-up">
 			...
 			<div class="row">
 				<div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
 					<div class="icon-box">
 						<div class="icon"><i class="bx bxl-dribbble"></i></div>
 						<h4><a href="consultation&audit.html">Consulting, Advisory & Counselling Area</a></h4>
 				...
 				<div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in"
 					...
 					<div class="icon-box">
 						<div class="icon"><i class="bx bx-file"></i></div>
 						<h4><a href="thefactoriesact1948.html">The Factories Act, 1948</a></h4>
 				...
 				<div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in"
 					...
 					<div class="icon-box">
 						<div class="icon"><i class="bx bx-tachometer"></i></div>
 						<h4><a href="employeesrovidentfundsandmiscellaneousprovisionsact.html">Employees' Provident
 								Funds and Miscellane-ous Provisions Act,1952</a></h4>
 				...
 				<div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in"
 					...
 					<div class="icon-box">
 						<div class="icon"><i class="bx bx-world"></i></div>
 						<h4><a href="employeesstateInsuranceact.html">Employees' State Insurance Act, 1948</a></h4>
 				...
 				<div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
 					<div class="icon-box">
 						...
 						<h4><a href="payrollservices.html">Payroll Services</a></h4>
 				...
 				<div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
 					<div class="icon-box">
 						...
 						<h4><a href="gujaratlabourwelfareactregulation.html">Gujarat Labour Welfare Act Regulation</a>
 						</h4>
 				...
 				<div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
 					<div class="icon-box">
 						<div class="icon"><i class="bx bx-arch"></i></div>
 						<h4><a href="buildingandotherconstruction.html">Building and Other Construction Workers Act,
 								1996</a></h4>
 						<p>Modi nostrum vel laborum. Porro fugit error sit minus sapiente sit aspernatur</p>
 					</div>
 				</div>
 				...
 				<div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
 					<div class="icon-box">
 						<div class="icon"><i class="bx bx-arch"></i></div>
 						<h4><a href="contractlabour.html">Contract Labour (Regulation & Abolition) Act, 1970</a></h4>
 						<p>Modi nostrum vel laborum. Porro fugit error sit minus sapiente sit aspernatur</p>
 					</div>
 				</div>
 			...
 			<div class="row">
 				...
 				<div class="col-lg-3 col-md-6 mt-5 mt-md-0">
 					<div class="count-box">
 						...
 						<span data-purecounter-start="0" data-purecounter-end="621" data-purecounter-duration="1"
 							class="purecounter"></span>
 						<p>Projects</p>
 					</div>
 				</div>
 					...
 					<div class="swiper-slide">
 						<div class="testimonial-item">
 							...
 							<p>
 								...
 								duis veniam ipsum anim magna sunt elit fore quem
 						...
 						<li>
 							...
 							<div id="faq6" class="collapse" data-bs-parent=".faq-list">
 								<p>
 									...
 									nunc eget lorem dolor sed. Ut venenatis tellus in metus vulputate eu scelerisque.
 									Pellentesque
