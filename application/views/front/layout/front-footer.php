  ...
  <footer id="footer">
  		...
  		<div class="container">
  			<div class="row">
  				...
  				<div class="col-lg-3 col-md-6 footer-contact">
  					<h3>Intact Consultancy<span>.</span></h3>
  					<p>
  						Intact consultancy is a highly professional <br> outfit having specialization in
  						consulting,<br> and advisory in labour and industrial laws. <br><br>
  						<strong>Phone:</strong> 079 – 26644253<br>
  						<strong>Email:</strong> mail@intactconsultancy.com<br>
  						<strong>Office TIme:</strong> Monday to Friday 10:00 to 06:30 PM<br>
  						<strong>Weekly Off:</strong> 1st & 3rd Saturday and All Sundays
  					</p>
  				</div>
  	...
  	<div class="container py-4">
  		<div class="copyright">
  			&copy; Copyright <strong><span>Intact Consultancy</span></strong>. All Rights Reserved
  		</div>
  		<div class="credits">
  			Designed by <a href="https://paavandarji.in/">Paavan Darji</a>
  		</div>
  	</div>
  </footer>
  <!-- End Footer -->
