		...
		<div class="container d-flex justify-content-center justify-content-md-between">
			<div class="contact-info d-flex align-items-center">
				<i class="bi bi-envelope d-flex align-items-center"><a
						href="mailto:mail@intactconsultancy.com">mail@intactconsultancy.com</a></i>
			...
			<nav id="navbar" class="navbar">
				<ul>
					...
					<li class="dropdown"><a href="#"><span>About Us</span> <i class="bi bi-chevron-down"></i></a>
						<ul>
							<li class="dropdown"><a href="about-us"><span>Company Profile</span></i></a></li>
							<li><a class="nav-link scrollto" href="ourteam">Our Team</a></li>
							<li><a class="nav-link scrollto" href="ourclient">Our Clients</a></li>
						</ul>
